...
//for width
const widthNormalized = (size: number) => {
	return normalize(size, "width");
};

//for height  pixel
const heightNormalized = (size: number) => {
...
const wn = widthNormalized;
const hn = heightNormalized;
const nfs = normalizeFontSize;
const afc = adjustFontConfig;

export { wn, hn, nfs, afc };
